...
/** A filesystem abstraction interface used for testing and probing without real I/O. */
...
/**
 * Probe a target directory for verification oracles (test runners, type checkers, linters, CI).
 *
 * @param target - The directory path to probe.
 * @param fsLike - The filesystem abstraction to use.
 * @param config - Optional configuration with custom probe definitions.
 * @returns An array of detected Oracle objects.
 */
