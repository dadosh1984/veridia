 ...
 *
 * @param id - The agent identifier to find.
 * @returns The AgentInfo if found, or undefined.
 */
 ...
 *
 * @returns A copy of the full agents array.
 */
...
/**
 * Format a veridia command invocation string for a given agent.
 * Uses the agent's invocation prefix and style (namespaced or flat).
 *
 * @param agent - The agent to format the invocation for.
 * @param commandId - The command identifier (e.g. "classify", "assess").
 * @returns The formatted invocation string (e.g. "/veridia:classify" or "/veridia-classify").
 */
